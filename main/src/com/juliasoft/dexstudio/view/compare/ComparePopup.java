	...
	private void initLayout()
	{
		...
		changeTab.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					display.changeSelectedTab(new DexCompareTab(display, (ClassGen) diff.getLeft(), (ClassGen) diff.getRight()));
				}
				if(diff.getDiffClass().equals(MethodGen.class))
				{
					display.changeSelectedTab(new DexCompareTab(display, (MethodGen) diff.getLeft(), (MethodGen) diff.getRight()));
				}
				if(diff.getDiffClass().equals(Annotation.class))
				{
					display.changeSelectedTab(new DexCompareTab(display, (Annotation) diff.getLeft(), (Annotation) diff.getRight()));
				}
		...
		newTab.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if(diff.getDiffClass().equals(ClassGen.class))
				{
					display.openNewTab(new DexCompareTab(display, (ClassGen) diff.getLeft(), (ClassGen) diff.getRight()));
				}
				if(diff.getDiffClass().equals(MethodGen.class))
				{
					display.openNewTab(new DexCompareTab(display, (MethodGen) diff.getLeft(), (MethodGen) diff.getRight()));
				}
				if(diff.getDiffClass().equals(Annotation.class))
				{
					display.openNewTab(new DexCompareTab(display, (Annotation) diff.getLeft(), (Annotation) diff.getRight()));
				}
				else if(diff.getDiffClass().equals(ContextGen.class))
				{
