...
public class TreeNode extends DefaultMutableTreeNode implements
		Comparable<TreeNode> {
	private String label;
	private NodeType type;

	public TreeNode(NodeType type, Object obj) throws IllegalArgumentException {
		if ((type.equals(NodeType.ROOT) || type.equals(NodeType.FOLDER) || type
				.equals(NodeType.PACKAGE))
				&& !(obj instanceof String)
				|| (type.equals(NodeType.CLASS) || type
						.equals(NodeType.INTERFACE))
				&& !(obj instanceof ClassGen)
				|| type.equals(NodeType.FIELD)
				&& !(obj instanceof FieldGen)
				|| type.equals(NodeType.METHOD)
				&& !(obj instanceof MethodGen)
