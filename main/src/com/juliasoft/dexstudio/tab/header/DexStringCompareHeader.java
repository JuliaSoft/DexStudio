...
public class DexStringCompareHeader extends JTextPane
{
	...
	private final String titleStyle = ".title{font-family:" + fontName + "; font-size:" + titleFontSize + "; color:" + color + "; font-weight:bold;}";
	...
	private final String htmlFormat = "<html><head><style type=\"text/css\">" + titleStyle + numStyle + numredStyle + numgreenStyle + "</style></head><body>";
	...
	public DexStringCompareHeader(DiffNode<?> ctx)
	{
		...
		for (DiffNode<?> node : ctx.getChildren()){
			...
			case RIGHT_ONLY: rightCount++; break;
			case LEFT_ONLY: leftCount++; break;
			default: ;			
		...
		String sameDiv = "<div class='num'>SameStrings#: " + sameCount + "</div>";
		String rightDiv = "<div class='num' id='red'>RightStrings#: " + rightCount + "</div>";
		String leftDiv = "<div class='num' id='green'>LeftStrings#: " + leftCount + "</div>";
		String totDiv = "<div class='num'>TotalStrings#: " + totCount + "</div>";
		
		String text = "<div class='title'>Strings</div>" + sameDiv + rightDiv + leftDiv + totDiv;
