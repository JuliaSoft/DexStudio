...
public class DexHomeTab extends JPanel implements DexTab
{
	...
	private final String descriptionStyle = ".description{font-family:" + fontName + "; font-size:" + descriptionFontSize + "; color:" + color + "; font-weight:normal; text-align:center;}";
	private final String htmlFormat = "<html><head><style type=\"text/css\">" + descriptionStyle + "</style></head><body>";
	private final String closeFormat = "</body></html>";
	
	public DexHomeTab()
	{
		super(new BorderLayout());
		JLabel textLabel = new JLabel(htmlFormat + "<div class='description'>Welcome to DexStudio</div>" + closeFormat);
