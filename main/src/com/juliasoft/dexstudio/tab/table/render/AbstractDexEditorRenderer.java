...
/**
 * Abstract renderer and editor for the table cells
 * 
 * 
...
public abstract class AbstractDexEditorRenderer extends AbstractCellEditor
	...
	private Component getComponent(Object value, int row, int column) {
		...
		cell.setBackground((row % 2 == 0) ? Color.WHITE : new Color(238, 238,
				239));
		cell.setBorder(BorderFactory.createMatteBorder(2, 3, 2, 2,
				(row % 2 == 0) ? Color.WHITE : new Color(238, 238, 239)));
