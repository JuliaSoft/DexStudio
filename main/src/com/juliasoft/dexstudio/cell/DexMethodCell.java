...
public class DexMethodCell extends JTextPane {
    ...
    public DexMethodCell(MethodGen meth)
    {
        ...
        String text = "<html><head><style type=\"text/css\">body{font-family:" + fontName + "; font-weight:normal; font-size:" + fontSize + "pt;color:" + color
                + ";}</style></head><body>";
        ...
        for (ParamGen param : meth.getParams())
        {
            ...
            text += ((params[j] != null) ? "<a href='par" + j + "'>" : "") + Library.printType(param.getType()) + ((params[j] != null) ? "</a>" : "")
                    + paramName;
            j++;
        }
        text += ")</body></html>";
