...
public class DexSearchList extends JTable
{
	 ...
	 * 
	 * @param nodes	The array of new results to be compared with the local one
	 * @param search	User input string for additional informations into the visualization
	 */
